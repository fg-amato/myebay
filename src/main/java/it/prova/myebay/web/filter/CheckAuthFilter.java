...
public class CheckAuthFilter implements Filter {
	...
	private static final String[] EXCLUDED_URLS = { "/public/", "/assets/" };
	private static final String[] USER_URLS = { "/utente/" };
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if (!isInWhiteList) {
			...
			if (isPathForOnlyAdministrators(pathAttuale) && !utenteInSession.isAdmin()) {
				...
				httpRequest.getRequestDispatcher("/utente/home.jsp").forward(httpRequest, httpResponse);
				return;
			}
		}
	...
	private boolean isPathForUsers(String requestPath) {
