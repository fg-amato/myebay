				                ...
				                <tbody>
				                	<c:forEach items="${utenti_list_attribute }" var="utenteItem">
										<tr>
											...
											<td>
<!-- da implementar -->							<a class="btn  btn-sm btn-outline-secondary" href="${pageContext.request.contextPath }/utente/ExecuteVisualizzaUtenteServlet?idUtente=${utenteItem.id }">Visualizza</a>
