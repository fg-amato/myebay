			...
			<main class="flex-shrink-0">
			  ...
			  <div class='card'>
				    ...
				    <div class='card-body'>
							...
							<c:forEach items="${ruoli_list_attr}" var="ruoloEntry">
							<div class="form-check">
								<input class="form-check-input" name="ruoloInput" type="checkbox" value="${ruoloEntry.id}" id="ruoloInput-${ruoloEntry.id}">
